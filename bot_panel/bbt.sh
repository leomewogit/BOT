...
BURIQ () {
    curl -sShttps://raw.githubusercontent.com/anzvps/reqAccess/main/ip > /root/tmp
...
echo -ne
curl -sS https://raw.githubusercontent.com/anzvps/BOT/main/bot_panel/scvpst.sh  | bash -
else
